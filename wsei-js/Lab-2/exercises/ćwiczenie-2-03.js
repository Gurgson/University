...
let threeLetersNamesFunc = (word) => {
  return word.length == 3 ? true : false;
};
let startsWithANamesFunc = (word) => {
  return word.startsWith("A");
};

let threeLetersNames = selectItems(names, threeLetersNamesFunc); //dodaj drugi arguemnt
let startsWithANames = selectItems(names, startsWithANamesFunc); //dodaj drugi argument
