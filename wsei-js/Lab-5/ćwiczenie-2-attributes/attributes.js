...
[...document.querySelectorAll("li")]
  .find((input) => input.innerHTML === "Karolina")
  .classList.add("border");

document.querySelector('input[name="title"]').toggleAttribute("disabled");

document.querySelector('input[name="year"]').setAttribute("max", "3000");

document.querySelectorAll("button")[0].type = "submit";
document.querySelectorAll("button")[1].type = "clear";
